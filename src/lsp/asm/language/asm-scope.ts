import type { AstNode, AstNodeDescription, LangiumDocument, PrecomputedScopes, Scope, ScopeOptions } from "langium";
...
export class AsmScopeProvider extends DefaultScopeProvider {
  override createScope(elements: Iterable<AstNodeDescription>, outerScope?: Scope, options?: ScopeOptions): Scope {
